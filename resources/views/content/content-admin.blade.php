                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 me-3">
                                                            <div class="avatar">
                                                                <img src="{{ asset('backend/img/avatars/2.png') }}"
                                                                    alt class="w-px-40 h-auto rounded-circle" />
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                ...
                                                <li
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 me-3">
                                                            <div class="avatar">
                                                                <img src="{{ asset('backend/img/avatars/9.png') }}"
                                                                    alt class="w-px-40 h-auto rounded-circle" />
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                ...
                                                <li
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 me-3">
                                                            <div class="avatar">
                                                                <img src="{{ asset('backend/img/avatars/5.png') }}"
                                                                    alt class="w-px-40 h-auto rounded-circle" />
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                ...
                                                <li
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 me-3">
                                                            <div class="avatar">
                                                                <img src="{{ asset('backend/img/avatars/6.png') }}"
                                                                    alt class="w-px-40 h-auto rounded-circle" />
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                ...
                                                <ul
                                                    ...
                                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        <img class="rounded-circle"
                                                            src="{{ asset('') }}backend/img/avatars/5.png"
                                                            alt="Avatar" />
                                                    </li>
                                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar avatar-xs pull-up">
                                                        <img class="rounded-circle"
                                                            src="{{ asset('') }}backend/img/avatars/12.png"
                                                            alt="Avatar" />
                                                    </li>
                                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar avatar-xs pull-up">
                                                        <img class="rounded-circle"
                                                            src="{{ asset('') }}backend/img/avatars/6.png"
                                                            alt="Avatar" />
                                                    </li>
                                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar avatar-xs pull-up">
                                                        <img class="rounded-circle"
                                                            src="{{ asset('') }}backend/img/avatars/14.png"
                                                            alt="Avatar" />
                                                    </li>
                                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar avatar-xs pull-up">
                                                        <img class="rounded-circle"
                                                            src="{{ asset('') }}backend/img/avatars/10.png"
                                                            alt="Avatar" />
                                                    </li>
                                                </ul>
                                            </div>
                                                ...
                                                <div class="timeline-event pb-2">
                                                    ...
                                                    <div class="d-flex">
                                                        <a href="javascript:void(0)" class="me-3">
                                                            <img src="{{ asset('') }}backend/img/icons/misc/pdf.png"
                                                ...
                                                <div class="timeline-event pb-0">
                                                    ...
                                                    <div class="d-flex align-items-center avatar-group">
                                                        ...
                                                        <div class="avatar avatar-sm pull-up"
                                                            ...
                                                            <img src="{{ asset('') }}backend/img/avatars/12.png"
                                                                alt="Avatar" class="rounded-circle" />
                                                        </div>
                                                        <div class="avatar avatar-sm pull-up"
                                                            data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        <div class="avatar avatar-sm pull-up"
                                                            ...
                                                            <img src="{{ asset('') }}backend/img/avatars/14.png"
                                                                alt="Avatar" class="rounded-circle" />
                                                        </div>
                                                    </div>
                                                </div>
