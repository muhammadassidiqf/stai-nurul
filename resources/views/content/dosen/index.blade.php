            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between mx-auto">
                        <h4 class="breadcrumb-wrapper mb-4">Data Dosen</h4>
                        <a href="{{ route('dosen.create') }}" class="btn btn-primary"><i
                                class='bx bxs-add-to-queue'></i>&nbsp;Tambah Dosen</a>
                    </div>
                </div>
...
@push('modals')
        ...
        <div class="modal-dialog modal-xl">
            <form class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTopTitle">Detail Dosen</h5>
    ...
    <div class="modal modal-top fade" id="showedit" tabindex="-1" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-xl">
            <form class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTopTitle">Edit Dosen</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="col-12 text-center">
